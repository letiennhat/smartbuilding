...
def loop_realtime():
  ...
  # global database
    ...
    try:
        ...
        # cursor.close()
        # cursor = database.cursor()
        cursor.execute("select id,hovaten,donvi,ngay,thang,nam,gio from realtime_0 where ngay = {}".format(str(time.localtime(time.time()).tm_mday)))
...
try :
    if not os.path.exists('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/video/'):
        os.mkdir('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/video/')
    else:
        pass
except:
    pass
app.config["VIDEO_UPLOADS"] = "/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/video/"
...
# app.config["IMAGE_UPLOADS"] = "/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/"
...
def uploadvideo1():
    try:
        ...
        print(type(filename))
        try:
            if not os.path.exists('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/video/'+str(id_)+'/'):
                os.mkdir('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/video/'+str(id_)+'/')
            else:
        ...
        #va_choose = request.form.get('reset_system')
            ...
            #keyboard.press('r')
        return render_template('uploadvideo.html',va = "đã upload thư mục url ="+'/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/video/'+str(id_)+'/',ba='input type=submit formaction=/uploadedvideo value=Begin-detect đã upload name=uploadedvideo')
    except:
        pass
app.config["IMAGE_UPLOADS"] = "/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/"
...
def uploadimage1():
    try:
        ...
        filename = secure_filename(image.filename)
        print(type(filename))
        if not os.path.exists('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/'+str(id_)+'/'):
            os.mkdir('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/'+str(id_)+'/')
        else:
            pass
        ...
        return render_template('uploadanh.html',va="đã Lưu vào thư mục : " + '/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/'+str(id_)+'/')
    except:
        pass
...
def uploaded_data():
    ...
    if value=="Xác nhận chính xác":
        try:
            if os.path.exists('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/'+str(id_)):
                os.rename('/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/'+str(id_),'/Users/letiennhat/racruoi/'+str(id(id_)))
            else:
                pass
            os.rename(os.getcwd() + '/uploads/','/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/'+str(id_))
            os.mkdir(os.getcwd() + '/uploads/')
        except:
            os.rename(os.getcwd() + '/uploads/','/Users/letiennhat/CP2020/smartbuilding/Blue_eyes/image_css/'+str(id_))
            os.mkdir(os.getcwd() + '/uploads/')
...
def hienthi_donvi_canhan(): 
    ...
    if len(name)>0:
        ...
        try:
            ...
            cursor = database.cursor()
            #cursor.execute("use mysqldb1")
            cursor.execute("select id,hovaten,donvi,ngaysinh,gioitinh,chucvu,trinhdo,hocham,ngay,thang,nam,gio,url from realtime_0 where donvi like '%{0}%'".format(choose))
    ...
    return render_template('test_pysql1.html',data=data_2,name=name) # fucntion 
...
def trangchu():
    ...
    if choose == "Học thông tin cá nhân mới":
        ...
        cursor.close()
        return render_template('dangxuat.html')
